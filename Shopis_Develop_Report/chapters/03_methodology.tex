...
\section{Examples of the sections of a Frontend folder}
...
\subsection{Example of a Backend/API Software and Web Development folder}
...
\subsection{Example of mobile folder (Flutter/React Native)}
...
\subsection{Example of Shared Utils and Components}
...
\subsection{Data architecture (Firebase, Firestore, Mongo schemas, etc.)}
...
\subsection{Security and authentification (JWT, OAuth, etc.)}
